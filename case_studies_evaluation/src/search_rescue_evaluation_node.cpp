...
int main(int argc, char** argv) {
  ...
  goal.target_pose.pose.position.x = -6.316;
  goal.target_pose.pose.position.y = -3.284;
  goal.target_pose.pose.orientation.z = 1.0;
  goal.target_pose.pose.orientation.w = -0.0184;
  ...
  // Stream life icon image
  std_msgs::String image_path_msg;
  image_path_msg.data = ros::package::getPath("case_studies_evaluation") + "/image/life_icon.jpg";
  ...
  goal.target_pose.header.stamp = ros::Time::now();
  goal.target_pose.pose.position.x = -7.094;
  goal.target_pose.pose.position.y = -3.328;
  goal.target_pose.pose.orientation.z = 1.0;
  goal.target_pose.pose.orientation.w = -0.111;
